...
async def delete_orders():
    await properties.trading_collection.delete_many({})
    # exchange = get_exchange(exchange_value)
...
async def get_open_orders():
    ...
    close_status_orders = properties.trading_collection.find({"close_status": "open"})
